...
export default function Header(){
    return (
        <header>
            <img src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/240/facebook/327/e-mail_1f4e7.png" alt='user'></img>
            <div id='top'>
                <h1>Shaswat Singh</h1>
                <p>Frontend Developer</p>
                <a id='website' href='https://shaswatsingh.vercel.app/' target={"_black"}>shaswatsingh.website</a>
                <a id='email' href='mailto:shaswatsingh.ose@gmail.com'>
